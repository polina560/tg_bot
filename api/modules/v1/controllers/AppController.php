...
use api\components\{requestLimiter\RequestLimiter, SessionAuth};
...
use yii\filters\{auth\CompositeAuth, auth\HttpBearerAuth, Cors};
 ...
 *
 * @method void addWrongValue(mixed $value) Добавление неправильного значения в RequestLimiter
 */
    ...
    public function behaviors(): array
    {
        return ArrayHelper::merge(parent::behaviors(), [
            ...
            'auth' => [
                ...
                'authMethods' => [
                    'sessionAuth' => ['class' => SessionAuth::class],
                    'bearerAuth' => ['class' => HttpBearerAuth::class]
                ]
            ],
            'returnStatus' => ['class' => ReturnStatusBehavior::class],
            'requestLimiter' => ['class' => RequestLimiter::class]
        ]);
    }
