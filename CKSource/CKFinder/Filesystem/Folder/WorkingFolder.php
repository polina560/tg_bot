...
class WorkingFolder extends Folder implements EventSubscriberInterface
{
     ...
     *
     * @return DirectoryAttributes[] list of directories
     * @throws FilesystemException
     */
     ...
     *
     * @return FileAttributes[] list of files
     * @throws FilesystemException
     */
    ...
    public function createDir(string $dirname): array
    {
        ...
        $locBackend->createDirectory($dirPath);
    ...
    public function write(string $fileName, string $data): void
    {
        ...
        $locBackend->write($filePath, $data);
    }
     ...
     * @throws FilesystemException
     */
    public function writeStream(string $fileName, $resource): void
    {
        $locBackend = $this->getBackend();
        $filePath = Path::combine($this->getPath(), $fileName);

        $locBackend->writeStream($filePath, $resource);
    }
     ...
     * @throws FilesystemException
     */
    public function putStream(string $fileName, $resource): void
    {
        $locBackend = $this->getBackend();
        $filePath = Path::combine($this->getPath(), $fileName);
        $locBackend->writeStream($filePath, $resource);
    ...
    public function delete(): void
    {
        ...
        $this->getBackend()->deleteDir($this->getPath());
    }
    ...
    public function rename(string $newName): array
    {
        ...
        $this->getBackend()->rename($this->getPath(), $newBackendPath);
