        ...
        foreach ($directories as $directory) {
            $data->folders[] = [
                ...
                'hasChildren' => $backend->containsDirectories(
                    $resourceType,
                    Path::combine($workingFolder->getClientCurrentFolder(), basename($directory->path()))
                ),
                'acl' => $directory->visibility() === Visibility::PUBLIC
                    ? Permission::FOLDER_VIEW | Permission::FOLDER_CREATE | Permission::FOLDER_DELETE | Permission::FOLDER_RENAME | Permission::FILE_VIEW | Permission::FILE_CREATE | Permission::FILE_DELETE | Permission::FILE_RENAME
