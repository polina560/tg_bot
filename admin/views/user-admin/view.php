...
<div class="user-admin-view">
    ...
    <p>
        ...
        <?php
        if ($model->hasTwoFaEnabled()): ?>
            <?= RbacHtml::a(
                Yii::t('app', 'Disable Two Factor Authentication'),
                ['disable-two-fa', 'id' => $model->id],
                [
                    'class' => 'btn btn-danger',
                    'data' => [
                        'confirm' => Yii::t('app', 'Are you sure you want to disable two factor authentication?'),
                        'method' => 'post',
                    ],
                ],
            ) ?>
        <?php
            ...
            <?= RbacHtml::a(Yii::t('app', 'Enable Two Factor Authentication'), ['enable-two-fa', 'id' => $model->id], [
                'class' => 'btn btn-primary',
            ]) ?>
        <?php
        endif ?>
        <?= RbacHtml::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id], [
            'class' => 'btn btn-danger',
            'data' => [
