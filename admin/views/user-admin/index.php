    ...
    <?= SortableGridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{view} {update} {password-change} {enable-two-fa} {disable-two-fa} {delete}',
                'buttons' => [
                    'password-change' => static fn($url)
                        => Html::a(
                        Icon::show('ellipsis-h'),
                        $url,
                        ['title' => 'Смена пароля', 'data-pjax' => '0'],
                    ),
                    'enable-two-fa' => static fn($url, $model) => $model->hasTwoFaEnabled()
                        ? ''
                        : Html::a(
                            Icon::show('lock'),
                            $url,
                            [
                                'title' => Yii::t('app', 'Enable Two Factor Authentication'),
                                'data-pjax' => '0',
                            ],
                        ),
                    'disable-two-fa' => static fn($url, $model) => !$model->hasTwoFaEnabled()
                        ? ''
                        : Html::a(
                            Icon::show('unlock'),
                            $url,
                            [
                                'title' => Yii::t('app', 'Disable Two Factor Authentication'),
                                'data-pjax' => '0',
                                'data-method' => 'post',
                                'data-confirm' => Yii::t(
                                    'app',
