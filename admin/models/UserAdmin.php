 ...
 * @method string|null getTwoFaSecret() Получение секретного ключа из атрибута модели
 * @method bool hasTwoFaEnabled() Возвращает статус включенности 2FA
 * @method string generateTwoFaSecret() Генерация нового секретного ключа
 * @method void enableTwoFa(string $secret = null) Включение 2FA с заданным или новым секретом
 * @method void disableTwoFa() Отключение 2FA, удаляя секретный ключ
 * @method bool validateTwoFaCode(string $code, ?string $secret = null, ?int $window = null) Проверка введенного кода на валидность
 * @method string getCurrentTwoFaCode(string $secret = null) Получение текущего кода 2FA
 */
