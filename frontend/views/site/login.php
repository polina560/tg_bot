...
<div class="site-login">
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <br><br>
            <p>Или войти через: </p>
            <script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="Test756978Bot" data-size="medium" data-onauth="onTelegramAuth(user)" data-request-access="write"></script>
