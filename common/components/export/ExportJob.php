...
class ExportJob extends BaseObject implements JobInterface, RetryableJobInterface
{
    ...
    public string|ExportConfig|null $staticConfig = null;
    ...
    private function writeRow(
        ...
        foreach ($this->columns as $key => $gridColumn) {
            if ($gridColumn instanceof DataColumn) {
                $value = $gridColumn->getDataCellValue($model, $key, $count);
            } elseif (array_key_exists('value', $gridColumn) && $gridColumn['value'] instanceof Closure) {
