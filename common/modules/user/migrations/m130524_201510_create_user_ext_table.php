...
class m130524_201510_create_user_ext_table extends Migration
{
    ...
    final public function safeUp(): void
    {
        ...
        $this->createIndex('{{%idx-user_ext-user_id}}', '{{%user_ext}}', 'user_id', true);
    ...
    final public function safeDown(): void
    {
        ...
        $this->dropForeignKey('{{%fk-user_ext-user_id}}', '{{%user_ext}}');

        // drops index for column `user_id`
        $this->dropIndex('{{%idx-user_ext-user_id}}', '{{%user_ext}}');
