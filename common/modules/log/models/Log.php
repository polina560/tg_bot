 ...
 */
class Log extends AppActiveRecord implements ExportConfig
{
    /**
     * {@inheritdoc}
     */
    ...
    public static function getColumns(): array
    {
        return [
            ...
            [
                ...
                'value' => fn(self $log) => LogOperation::from($log->operation_type)->description()
            ],
            'before',
            'after',
            'time:datetime',
            [
                ...
                'value' => fn(self $log) => $log->userAdmin->username
            ],
            'user_agent',
            'ip:ip',
            [
                'attribute' => 'status',
                'value' => fn(self $log) => LogStatus::from($log->status)->description()
            ],
            'description',
        ];
    }
